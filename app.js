const quiz = [
  {
    question:'（交通局HP）地下鉄南北線の新型車両は「　」系である',
    answers: ['2000','3000','4000','5000' ],
    correct:'3000'
  },{
    question:'（交通局HP）仙台市交通局のマスコットキャラクターの名前はどれか。',
    answers: ['イクスカくん','イクスカちゃん','イクスカすずめ','むすび丸' ],
    correct:'イクスカすずめ'
  },{
    question:'（交通局HP）令和6年4月1日のダイヤ改正で廃止されたるーぷる仙台の路線の停留所はどれか。',
    answers: ['仙台城跡','理学部自然史標本館前','青葉山植物園西','青葉山駅' ],
    correct:'青葉山植物園西'
  },{
    question:'（交通局HP）仙台市交通局では、「　」年11月25日に仙台市電が開業しました。',
    answers: ['1925','1926','1935','1936' ],
    correct:'1926'
  },{
    question:'（交通局HP）その後、「　」年8月21日には市バス、1987年7月15日には地下鉄南北線が開業しました。',
    answers: ['1932','1942','1952','1962' ],
    correct:'1942'
  },{
    ...
    question:'（バス事故対応等マニュアル）前車が急停車しても、これに追突するのを避けることのできる適切な車間距離を保つこと。又、停車時は前者との車間距離を可能な限り「　」m以上あけること。',
    answers: ['1.0','1.5','2.0','2.5' ],
    correct:'2.5'
  },{
